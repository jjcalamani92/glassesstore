          ...
          <div className="container px-6 justify-between h-16 flex items-center lg:items-stretch mx-auto">
            <div className="h-full flex items-center">
              ...
              <ul className="pr-12 xl:flex items-center h-full hidden">
                <li 
                  className={pathname === '/admin' ? "cursor-pointer h-full flex items-center text-sm text-rose-600 tracking-normal border-b-2 border-rose-600 " : "cursor-pointer h-full flex items-center text-sm text-gry-800 mr-10 tracking-normal"}
                ...
                <li 
                  className={pathname === '/admin/sites' ? "cursor-pointer h-full flex items-center text-sm text-rose-600 tracking-normal border-b-2 border-rose-600 " : "cursor-pointer h-full flex items-center text-sm text-gry-800 mx-10 tracking-normal"}
