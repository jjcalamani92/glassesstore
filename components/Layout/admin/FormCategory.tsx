      ...
      <div className="max-w-2xl mx-auto pt-10 pb-16 px-1 sm:px-6 lg:max-w-7xl lg:pt-16 lg:pb-24 lg:px-8 ">
        ...
        <div className="md:col-span-1">
            <div className="px-4 sm:px-0">
              <h3 className="text-lg font-medium leading-6 text-gray-900">Datos de la Categoría</h3>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
              <div className="shadow sm:rounded-md sm:overflow-hidden">
                <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700">Imagen de Categoría</label>
                    ...
                    <div>
                      <label htmlFor="imageAlt" className="block text-sm font-medium text-gray-700 mt-1">
