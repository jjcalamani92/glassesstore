...
import { Category, IGlasses, Section } from "../../../../../src/interfaces";
						...
						<>
							<div className="my-6 container px-2 mx-auto flex flex-row lg:flex-row items-center lg:items-center justify-between ">
								...
								<Link href={`/admin/sites/${router.query.category}/${router.query.section}/new`}>
									<a className="transition duration-150 ease-in-out hover:bg-rose-500 focus:outline-none border bg-rose-600 rounded text-white px-8 py-2 text-sm">Nuevo Item</a>
								</Link>
							</div>
